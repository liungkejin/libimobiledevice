 ...
 */
LIBIMOBILEDEVICE_API_MSC preboard_error_t preboard_client_new(idevice_t device, lockdownd_service_descriptor_t service, preboard_client_t * client);
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC preboard_error_t preboard_client_start_service(idevice_t device, preboard_client_t * client, const char* label);
 ...
 */
LIBIMOBILEDEVICE_API_MSC preboard_error_t preboard_client_free(preboard_client_t client);
 ...
 */
LIBIMOBILEDEVICE_API_MSC preboard_error_t preboard_send(preboard_client_t client, plist_t plist);
 ...
 *  or a PREBOARD_E_* error code on error
 */
LIBIMOBILEDEVICE_API_MSC preboard_error_t preboard_receive(preboard_client_t client, plist_t * plist);
 ...
 *  or a PREBOARD_E_* error code on error.
 */
LIBIMOBILEDEVICE_API_MSC preboard_error_t preboard_receive_with_timeout(preboard_client_t client, plist_t * plist, uint32_t timeout_ms);
 ...
 *  or a PREBOARD_E_* error code on error.
 */
LIBIMOBILEDEVICE_API_MSC preboard_error_t preboard_create_stashbag(preboard_client_t client, plist_t manifest, preboard_status_cb_t status_cb, void *user_data);
 ...
 *  or a PREBOARD_E_* error code on error.
 */
LIBIMOBILEDEVICE_API_MSC preboard_error_t preboard_commit_stashbag(preboard_client_t client, plist_t manifest, preboard_status_cb_t status_cb, void *user_data);
