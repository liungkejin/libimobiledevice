 ...
 */
LIBIMOBILEDEVICE_API_MSC webinspector_error_t webinspector_client_new(idevice_t device, lockdownd_service_descriptor_t service, webinspector_client_t * client);
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC webinspector_error_t webinspector_client_start_service(idevice_t device, webinspector_client_t * client, const char* label);
 ...
 *     client is NULL, or an WEBINSPECTOR_E_* error code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC webinspector_error_t webinspector_client_free(webinspector_client_t client);
 ...
 */
LIBIMOBILEDEVICE_API_MSC webinspector_error_t webinspector_send(webinspector_client_t client, plist_t plist);
 ...
 *  DIAGNOSTICS_RELAY_E_INVALID_ARG when client or plist is NULL
 */
LIBIMOBILEDEVICE_API_MSC webinspector_error_t webinspector_receive(webinspector_client_t client, plist_t * plist);
 ...
 */
LIBIMOBILEDEVICE_API_MSC webinspector_error_t webinspector_receive_with_timeout(webinspector_client_t client, plist_t * plist, uint32_t timeout_ms);
