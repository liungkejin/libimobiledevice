 ...
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_client_new(idevice_t device, lockdownd_service_descriptor_t service, instproxy_client_t *client);
 ...
 *         code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_client_start_service(idevice_t device, instproxy_client_t * client, const char* label);
 ...
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_client_free(instproxy_client_t client);
 ...
 *         an error occurred.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_browse(instproxy_client_t client, plist_t client_options, plist_t *result);
 ...
 *         an error occurred.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_browse_with_callback(instproxy_client_t client, plist_t client_options, instproxy_status_cb_t status_cb, void *user_data);
 ...
 *         an error occurred.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_lookup(instproxy_client_t client, const char** appids, plist_t client_options, plist_t *result);
 ...
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_install(instproxy_client_t client, const char *pkg_path, plist_t client_options, instproxy_status_cb_t status_cb, void *user_data);
 ...
 *       handled inside the specified callback function.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_upgrade(instproxy_client_t client, const char *pkg_path, plist_t client_options, instproxy_status_cb_t status_cb, void *user_data);
 ...
 *       handled inside the specified callback function.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_uninstall(instproxy_client_t client, const char *appid, plist_t client_options, instproxy_status_cb_t status_cb, void *user_data);
 ...
 *         an error occurred.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_lookup_archives(instproxy_client_t client, plist_t client_options, plist_t *result);
 ...
 *       handled inside the specified callback function.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_archive(instproxy_client_t client, const char *appid, plist_t client_options, instproxy_status_cb_t status_cb, void *user_data);
 ...
 *       handled inside the specified callback function.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_restore(instproxy_client_t client, const char *appid, plist_t client_options, instproxy_status_cb_t status_cb, void *user_data);
 ...
 *       handled inside the specified callback function.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_remove_archive(instproxy_client_t client, const char *appid, plist_t client_options, instproxy_status_cb_t status_cb, void *user_data);
 ...
 *         an error occurred.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_check_capabilities_match(instproxy_client_t client, const char** capabilities, plist_t client_options, plist_t *result);
 ...
 */
LIBIMOBILEDEVICE_API_MSC void instproxy_command_get_name(plist_t command, char** name);
 ...
 */
LIBIMOBILEDEVICE_API_MSC void instproxy_status_get_name(plist_t status, char **name);
 ...
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_status_get_error(plist_t status, char **name, char** description, uint64_t* code);
 ...
 */
LIBIMOBILEDEVICE_API_MSC void instproxy_status_get_current_list(plist_t status, uint64_t* total, uint64_t* current_index, uint64_t* current_amount, plist_t* list);
 ...
 */
LIBIMOBILEDEVICE_API_MSC void instproxy_status_get_percent_complete(plist_t status, int *percent);
 ...
 */
LIBIMOBILEDEVICE_API_MSC plist_t instproxy_client_options_new(void);
 ...
 */
LIBIMOBILEDEVICE_API_MSC void instproxy_client_options_add(plist_t client_options, ...);
 ...
 */
LIBIMOBILEDEVICE_API_MSC void instproxy_client_options_set_return_attributes(plist_t client_options, ...);
 ...
 *        is passed.
 */
LIBIMOBILEDEVICE_API_MSC void instproxy_client_options_free(plist_t client_options);
 ...
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_client_get_path_for_bundle_identifier(instproxy_client_t client, const char* bundle_id, char** path);
