 ...
 */
LIBIMOBILEDEVICE_API_MSC void reverse_proxy_client_set_status_callback(reverse_proxy_client_t client, reverse_proxy_status_cb_t callback, void* user_data);
 ...
 * @param user_data A pointer that will be passed to the callback function.
 */
LIBIMOBILEDEVICE_API_MSC void reverse_proxy_client_set_log_callback(reverse_proxy_client_t client, reverse_proxy_log_cb_t callback, void* user_data);
...
LIBIMOBILEDEVICE_API_MSC void reverse_proxy_client_set_data_callback(reverse_proxy_client_t client, reverse_proxy_data_cb_t callback, void* user_data);
