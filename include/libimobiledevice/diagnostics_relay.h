 ...
 */
LIBIMOBILEDEVICE_API_MSC diagnostics_relay_error_t diagnostics_relay_client_new(idevice_t device, lockdownd_service_descriptor_t service, diagnostics_relay_client_t *client);
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC diagnostics_relay_error_t diagnostics_relay_client_start_service(idevice_t device, diagnostics_relay_client_t* client, const char* label);
 ...
 */
LIBIMOBILEDEVICE_API_MSC diagnostics_relay_error_t diagnostics_relay_client_free(diagnostics_relay_client_t client);
 ...
 *  request
 */
LIBIMOBILEDEVICE_API_MSC diagnostics_relay_error_t diagnostics_relay_goodbye(diagnostics_relay_client_t client);
 ...
 *  request
 */
LIBIMOBILEDEVICE_API_MSC diagnostics_relay_error_t diagnostics_relay_sleep(diagnostics_relay_client_t client);
 ...
 *  request
 */
LIBIMOBILEDEVICE_API_MSC diagnostics_relay_error_t diagnostics_relay_restart(diagnostics_relay_client_t client, diagnostics_relay_action_t flags);
 ...
 *  request
 */
LIBIMOBILEDEVICE_API_MSC diagnostics_relay_error_t diagnostics_relay_shutdown(diagnostics_relay_client_t client, diagnostics_relay_action_t flags);
 ...
 *  request
 */
LIBIMOBILEDEVICE_API_MSC diagnostics_relay_error_t diagnostics_relay_request_diagnostics(diagnostics_relay_client_t client, const char* type, plist_t* diagnostics);
 ...
 *  request
 */
LIBIMOBILEDEVICE_API_MSC diagnostics_relay_error_t diagnostics_relay_query_ioregistry_entry(diagnostics_relay_client_t client, const char* entry_name, const char* entry_class, plist_t* result);
